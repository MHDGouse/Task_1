import unittest
from Soluction_client3 import getDataPoint, getRatio
...
class ClientTest(unittest.TestCase):
    ...
    def test_getDataPoint_calculatePrice(self):
        ...
        for quote in quotes:
            ...
            self.assertEqual((stock, bid_price, ask_price, price), (quote['stock'], quote['top_bid']['price'],
    ...
    def test_getRatio_normalCase(self):
        price_a = 15.0
        price_b = 5.0
        self.assertEqual(getRatio(price_a, price_b), 3.0)
